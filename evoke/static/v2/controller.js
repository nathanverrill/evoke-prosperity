...
(function(){
  ...
  // Verified path only: QR -> Field Kit -> two-channel code confirm
  // (companion.html). The direct "type your Minecraft username" box this
  // used to also offer called /api/minecraft/link with zero verification
  // that the caller actually controls that username -- anyone could type a
  // classmate's name and claim their account. Removed rather than left as
  // a second, weaker path alongside the real one.
  (function(){
